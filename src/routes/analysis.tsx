    ...
    <TopShell>
      <div className="mx-auto w-full max-w-6xl min-w-0 px-3 py-4 sm:px-4 sm:py-6 md:px-8">
        ...
        <div className="mt-4 grid min-w-0 gap-3 sm:grid-cols-[minmax(0,1fr)_auto] lg:flex lg:flex-wrap lg:items-end lg:gap-4">
          ...
          <div className="min-w-0 rounded-md bg-slate-100 px-4 py-2 text-center sm:col-span-2 lg:col-span-1">
            <div className="font-mono text-2xl font-bold text-slate-800">
              {last !== null ? last.toFixed(2) : "—"}
            </div>
            <div className="truncate text-[10px] text-slate-500 uppercase tracking-wider">
              {marketName}
            </div>
          </div>
          <div className="text-xs text-slate-500 sm:col-span-2 lg:col-span-1">
