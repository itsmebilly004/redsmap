    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          { label: "ROI", value: `${stats.roi.toFixed(2)}%`, accent: stats.roi >= 0 ? "text-success" : "text-destructive" },
        ].map((s) => (
          ...
          {stats.equity.length === 0 ? (
            ...
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={stats.equity}>
                ...
                />
                <Area type="monotone" dataKey="y" stroke="oklch(0.78 0.16 230)" fill="url(#g)" strokeWidth={1.5} />
              </AreaChart>
            </ResponsiveContainer>
          )}
        </div>
