...
const ArrowDownUp = createLucideIcon("arrow-down-up", __iconNode$Y);
const __iconNode$X = [
...
const ChartBar = createLucideIcon("chart-bar", __iconNode$T);
const __iconNode$S = [
...
const ChartCandlestick = createLucideIcon("chart-candlestick", __iconNode$S);
const __iconNode$R = [
  ["path", { d: "M3 3v16a2 2 0 0 0 2 2h16", key: "c24i48" }],
...
const Microscope = createLucideIcon("microscope", __iconNode$q);
...
const Plug = createLucideIcon("plug", __iconNode$n);
const __iconNode$m = [
  ["path", { d: "M5 12h14", key: "1ays0h" }],
