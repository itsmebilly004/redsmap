...
import { u as useRouterState, a as useDerivBalance, D as DropdownMenu, b as DropdownMenuTrigger, c as DropdownMenuContent, d as DropdownMenuItem, C as ChartColumn } from "./dropdown-menu-BB1zg0X4.mjs";
import { B as Button } from "./button-Cbaj921o.mjs";
import { u as useAuth } from "./use-auth-D880YEmu.mjs";
import { b as buildOAuthUrl, c as createLucideIcon } from "./createLucideIcon-vFonUMpr.mjs";
...
const ChartCandlestick = createLucideIcon("chart-candlestick", __iconNode$8);
const __iconNode$7 = [
  ["path", { d: "M3 3v16a2 2 0 0 0 2 2h16", key: "c24i48" }],
  ["path", { d: "m19 9-5 5-4-4-3 3", key: "2osh9i" }]
];
const ChartLine = createLucideIcon("chart-line", __iconNode$7);
const __iconNode$6 = [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 md:gap-2", children: [
        user && account && /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "flex items-center gap-1.5 rounded-md border border-[oklch(0.92_0.005_240)] bg-white px-2 py-1.5 text-left transition hover:bg-[oklch(0.97_0.003_240)] md:gap-2 md:px-3", children: [
            ...
            accounts.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "size-3.5 text-[oklch(0.5_0.02_260)]" })
          ] }) }),
          accounts.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuContent, { align: "end", className: "w-60", children: accounts.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            DropdownMenuItem,
            {
        ...
        user && !account && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
        ...
        user ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/dashboard", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Open dashboard" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sm:hidden", children: "Dashboard" })
            ] })
          }
