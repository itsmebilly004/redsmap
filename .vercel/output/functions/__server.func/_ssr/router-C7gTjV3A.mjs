import { u as useRouter, j as jsxRuntimeExports, c as compileDecodeCharMap, a as createLRUCache, t as trimPath, r as rewriteBasepath, b as composeRewrites, p as processRouteTree, d as processRouteMasks, e as resolvePath, f as cleanPath, g as trimPathRight, h as createControlledPromise, i as parseHref, k as executeRewriteInput, l as isDangerousProtocol, m as redirect, n as isRedirect, o as isNotFound, q as findSingleMatch, s as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, v as interpolatePath, w as nullReplaceEqualDeep, x as replaceEqualDeep, y as last, z as decodePath, A as findFlatMatch, B as functionalUpdate, C as findRouteMatch, E as isPromise, F as invariant, G as rootRouteId, H as notFound, I as executeRewriteOutput, J as arraysEqual, R as React, K as reactExports, L as dummyMatchContext, M as matchContext, N as isModuleNotFoundError, O as isServer, P as trimPathLeft, Q as joinPaths, S as exactPathTest, T as removeTrailingSlash, U as encodePathLikeUrl, V as requireReactDom, W as Outlet, X as escapeHtml, Y as getAssetCrossOrigin, Z as useHydrated, _ as getDefaultExportFromCjs, $ as resolveManifestAssetLink } from "./index.mjs";
import "node:events";
...
function stringifySearchWith(stringify, parser) {
  ...
  return (search2) => {
    const searchStr = encode(search2, stringifyValue);
...
var isBeforeLoadSsr = (inner, matchId, index, route) => {
  ...
  const { search: search2, params } = existingMatch;
  const ssrFnContext = {
    search: makeMaybe(search2, existingMatch.searchError),
...
var executeBeforeLoad = (inner, matchId, index, route) => {
  ...
  const { search: search2, params, cause } = match;
  ...
  */
  constructor(options, getStoreConfig) {
    ...
    this.parseLocation = (locationToParse, previousLocation) => {
      const parse = ({ pathname, search: search2, hash, href, state }) => {
        if (!this.rewrite && !/[ \x00-\x1f\x7f\u0080-\uffff]/.test(pathname)) {
          const parsedSearch2 = this.options.parseSearch(search2);
...
function applySearchMiddleware({ search: search2, dest, destRoutes, _includeValidateSearch }) {
  return buildMiddlewareChain(destRoutes)(search2, dest, _includeValidateSearch ?? false);
}
function buildMiddlewareChain(destRoutes) {
  ...
  return function middleware(search2, dest, _includeValidateSearch) {
    context.dest = dest;
    context._includeValidateSearch = _includeValidateSearch;
    return applyNext(0, search2, context.middlewares);
  };
}
...
const appCss = "/assets/styles-Bx2_GEfV.css";
...
const $$splitComponentImporter$g = () => import("./tradingview-DIK6MZjW.mjs");
...
const $$splitComponentImporter$f = () => import("./trading-bots-CNCmNGFp.mjs");
...
const $$splitComponentImporter$e = () => import("./strategies-Dg3g374V.mjs");
...
ZodOptional.create;
ZodNullable.create;
const $$splitComponentImporter$d = () => import("./deriv-callback-gGJaEhr5.mjs");
...
const $$splitComponentImporter$c = () => import("./dashboard-ZITFpSQL.mjs");
const Route$c = createFileRoute("/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./copy-trading-DPZ3-WRA.mjs");
...
const $$splitComponentImporter$a = () => import("./charts-Dn-AjYXq.mjs");
...
const $$splitComponentImporter$9 = () => import("./bot-builder-Bltu58CC.mjs");
...
const $$splitComponentImporter$8 = () => import("./auth-BC8f88sr.mjs");
...
const $$splitComponentImporter$7 = () => import("./analysis-C_oum5eu.mjs");
...
const $$splitComponentImporter$6 = () => import("./index-BNm-bsRC.mjs");
...
const $$splitComponentImporter$5 = () => import("./dashboard.index-BWpZ_bQM.mjs");
...
const $$splitComponentImporter$4 = () => import("./strategy._slug-C1crNqOz.mjs");
...
const $$splitComponentImporter$3 = () => import("./dashboard.trade-D9KOc4Db.mjs");
const Route$3 = createFileRoute("/dashboard/trade")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./dashboard.settings-DJ-HQlgq.mjs");
const Route$2 = createFileRoute("/dashboard/settings")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./dashboard.bot-NsMiFEtS.mjs");
const Route$1 = createFileRoute("/dashboard/bot")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./dashboard.analytics-BcLRcpG7.mjs");
const Route2 = createFileRoute("/dashboard/analytics")({
...
const DashboardAnalyticsRoute = Route2.update({
  id: "/analytics",
  path: "/analytics",
  getParentRoute: () => DashboardRoute
});
