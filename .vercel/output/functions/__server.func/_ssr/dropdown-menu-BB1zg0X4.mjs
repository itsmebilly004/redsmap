import { u as useRouter, K as reactExports, j as jsxRuntimeExports } from "./index.mjs";
import { s as supabase } from "./client-B-NvnhGF.mjs";
import { u as useAuth } from "./use-auth-D880YEmu.mjs";
import { g as subscribeBalance, c as createLucideIcon } from "./createLucideIcon-vFonUMpr.mjs";
import { u as useControllableState, P as Primitive, c as composeEventHandlers, a as createContextScope, e as dispatchDiscreteCustomEvent, f as useLayoutEffect2 } from "./index-BVBDj44R.mjs";
import { b as composeRefs, c as cn, u as useComposedRefs } from "./button-Cbaj921o.mjs";
import { a as useId, d as useCallbackRef$1, u as useDirection, e as Root2$1, A as Anchor, f as createPopperScope, P as Portal$1, g as createCollection, h as hideOthers, R as ReactRemoveScroll, c as useFocusGuards, F as FocusScope, D as DismissableLayer, i as Content, j as Arrow, b as Check } from "./Combination-DLUKXKiD.mjs";
    ...
    (async () => {
      try {
        unsub = await subscribeBalance(active.deriv_token, async (b) => {
          ...
          await supabase.from("sessions").update({ balance: b.balance, currency: b.currency }).eq("user_id", user.id).eq("account_id", active.account_id);
        });
      } catch {
      }
    })();
