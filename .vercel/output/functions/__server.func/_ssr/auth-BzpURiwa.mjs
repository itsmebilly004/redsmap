...
import { b as Route$8, u as useAuth, d as useDerivBalance, e as buildOAuthUrl } from "./router-R6L_Ezj3.mjs";
import "../_libs/sonner.mjs";
import { u as ShieldCheck, d as ArrowRight } from "../_libs/lucide-react.mjs";
...
function AuthPage() {
  ...
  const headline = isReconnect ? "Connect your Deriv account" : isSignup ? "Create your account" : "Welcome back";
  const subtitle = isReconnect ? "You're already signed in. Click below to link your Deriv account and start trading." : isSignup ? "You'll be redirected to Deriv to register, then sent straight back to the platform." : "Continue with the Deriv account you already use to trade — no passwords stored here.";
  const btnLabel = busy ? "Redirecting…" : isReconnect ? "Connect Deriv account" : isSignup ? "Sign up with Deriv" : "Sign in with Deriv";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative grid min-h-dvh place-items-center px-4 py-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-md", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-2xl p-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-semibold tracking-tight", children: headline }),
        ...
        !isReconnect && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-6 text-center text-sm text-muted-foreground", children: [
        ...
        isReconnect && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-center text-sm text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "text-primary hover:underline", children: "← Back to trading" }) })
      ] }),
