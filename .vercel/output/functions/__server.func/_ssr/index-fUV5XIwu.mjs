...
import { u as useAuth, d as useDerivBalance, k as SIDES_BY_CATEGORY, T as TRADE_CATEGORIES, s as send, l as subscribeProposal, e as buildOAuthUrl, h as fetchPortfolio, i as subscribeOpenContract, c as contractTypeFor, a as supabase, j as sellContract } from "./router-R6L_Ezj3.mjs";
...
import { o as Shield, B as Bot, v as Crosshair, p as Sun, q as CircleQuestionMark, w as Settings, G as Globe, r as Maximize2, x as ChevronLeft, y as ChevronRight, I as Info, z as Minus, E as Plus, c as TrendingUp, J as TrendingDown, L as LoaderCircle, X } from "../_libs/lucide-react.mjs";
...
function registerOpenContract(contractId) {
...
function OpenContractsPanel() {
  ...
  const [contracts, setContracts] = reactExports.useState(/* @__PURE__ */ new Map());
  const unsubsRef = reactExports.useRef(/* @__PURE__ */ new Map());
  const [selling, setSelling] = reactExports.useState(/* @__PURE__ */ new Set());
  ...
  async function subscribeToContract(contractId) {
  ...
  async function handleSell(contractId, bidPrice) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "border-t border-[oklch(0.92_0.005_240)] bg-white px-3 py-3 lg:px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2 text-xs font-semibold uppercase tracking-wider text-[oklch(0.45_0.02_260)]", children: [
      "Open Contracts (",
      openCount,
      ")"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: list.map((c) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: cn(
            ...
            settled ? isWin ? "border-emerald-200 bg-emerald-50" : "border-rose-200 bg-rose-50" : "border-[oklch(0.92_0.005_240)] bg-[oklch(0.98_0.003_240)]"
          ),
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: cn(
                  ...
                  settled ? isWin ? "bg-emerald-500" : "bg-rose-500" : "bg-[oklch(0.55_0.22_265)]"
                ),
                children: settled ? isWin ? /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "size-3.5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "size-3.5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "size-3.5 animate-spin" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 font-medium", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: contractLabel(c.contract_type) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-[oklch(0.55_0.02_260)]", children: [
                  "· ",
                  c.underlying
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-0.5 flex flex-wrap items-center gap-2 font-mono text-[10px] text-[oklch(0.5_0.02_260)]", children: [
                ...
                c.entry_spot != null && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  "Entry ",
                  c.entry_spot.toFixed(4)
                ] }),
                !settled && c.current_spot != null && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  "Now ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: cn(
                    ...
                    c.profit != null ? isWin ? "text-emerald-600" : "text-rose-600" : "text-[oklch(0.45_0.02_260)]"
                  ),
                  children: c.profit != null ? `${isWin ? "+" : ""}${profit.toFixed(2)} ${c.currency}` : "—"
                }
              ),
              c.profit_percentage != null && !settled && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("text-[10px]", isWin ? "text-emerald-500" : "text-rose-500"), children: [
                isWin ? "+" : "",
                c.profit_percentage.toFixed(2),
                "%"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0", children: settled ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => dismiss(c.contract_id),
                className: "rounded-full p-1 hover:bg-black/5",
                "aria-label": "Dismiss",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "size-3.5 text-[oklch(0.5_0.02_260)]" })
              }
            ) : c.is_valid_to_sell ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                size: "sm",
                variant: "outline",
                ...
                children: selling.has(c.contract_id) ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "size-3 animate-spin" }) : "Sell"
              }
            ) : null })
          ]
        },
...
function Index() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(TopShell, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(OpenContractsPanel, {}),
