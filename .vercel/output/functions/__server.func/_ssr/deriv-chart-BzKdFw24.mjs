...
import { h as getActiveSymbols, S as SYNTHETIC_MARKETS, o as onStatus, i as fetchTicks, j as fetchCandles, d as subscribeTicks } from "./createLucideIcon-vFonUMpr.mjs";
...
function DerivChart({
  ...
  reactExports.useEffect(() => {
    ...
    const series = chart.addSeries(Ue, {
      lineColor: "#1f2937",
      lineWidth: 2,
  ...
  const symbolOptions = reactExports.useMemo(() => {
    if (allSymbols.length === 0)
      return SYNTHETIC_MARKETS.map((m2) => ({
        symbol: m2.symbol,
        display_name: m2.name
      }));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex flex-wrap items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: symbol, onValueChange: (v2) => onSymbolChange?.(v2), children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { className: "max-h-80", children: symbolOptions.map((m2) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: m2.symbol, children: m2.display_name }, m2.symbol)) })
      ] }),
      !isAccumulator && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex overflow-hidden rounded-md border border-glass-border", children: TIMEFRAMES.map((tf) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
