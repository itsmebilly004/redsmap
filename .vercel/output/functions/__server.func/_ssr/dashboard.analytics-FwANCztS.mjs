import { K as reactExports, j as jsxRuntimeExports, R as React, _ as getDefaultExportFromCjs, a1 as commonjsGlobal } from "./index.mjs";
import { u as useAuth, b as supabase } from "./router-BtJUm4Bw.mjs";
import { c as clsx } from "./clsx-DgYk2OaC.mjs";
import "node:events";
...
function AnalyticsPage() {
  ...
  const stats = reactExports.useMemo(() => {
    ...
    const totalStake = trades.reduce((a2, t) => a2 + Number(t.stake ?? 0), 0);
    const profit = trades.reduce((a2, t) => a2 + Number(t.profit_loss ?? 0), 0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    }].map((s2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-xl p-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-wider text-muted-foreground", children: s2.label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `mt-3 font-mono text-2xl ${s2.accent ?? ""}`, children: s2.value })
    ] }, s2.label)) }),
