...
async function subscribeOpenContract(contractId, onUpdate) {
  const ws = await connect();
  const id = reqId++;
...
async function sellContract(contractId, price = 0) {
...
const appCss = "/assets/styles-cCb6MBX4.css";
...
const $$splitComponentImporter$g = () => import("./tradingview-DxUf_MRj.mjs");
...
const $$splitComponentImporter$f = () => import("./trading-bots-CFJcV9or.mjs");
...
const $$splitComponentImporter$e = () => import("./strategies-BXbN0fj5.mjs");
...
const $$splitComponentImporter$d = () => import("./deriv-callback-BqnU4Xw0.mjs");
...
const $$splitComponentImporter$c = () => import("./dashboard-BFsOu0JM.mjs");
...
const $$splitComponentImporter$b = () => import("./copy-trading-CNHDJvPz.mjs");
...
const $$splitComponentImporter$a = () => import("./charts-DOqFpyWK.mjs");
...
const $$splitComponentImporter$9 = () => import("./bot-builder-C6qAbMbg.mjs");
...
const $$splitComponentImporter$8 = () => import("./auth-BzpURiwa.mjs");
...
const $$splitComponentImporter$7 = () => import("./analysis-Cre8vddi.mjs");
...
const $$splitComponentImporter$6 = () => import("./index-fUV5XIwu.mjs");
...
const $$splitComponentImporter$4 = () => import("./strategy._slug-Dwj4R3uP.mjs");
...
const $$splitComponentImporter$3 = () => import("./dashboard.trade-BTU5dmpx.mjs");
...
const $$splitComponentImporter$2 = () => import("./dashboard.settings-BTU5dmpx.mjs");
...
const $$splitComponentImporter$1 = () => import("./dashboard.bot-BTU5dmpx.mjs");
...
const $$splitComponentImporter = () => import("./dashboard.analytics-BTU5dmpx.mjs");
...
export {
  ...
  supabase as a,
  Route$8 as b,
  contractTypeFor as c,
  useDerivBalance as d,
  buildOAuthUrl as e,
  subscribeTicks as f,
  SYNTHETIC_MARKETS as g,
  fetchPortfolio as h,
  subscribeOpenContract as i,
  sellContract as j,
  SIDES_BY_CATEGORY as k,
  subscribeProposal as l,
  getActiveSymbols as m,
  fetchTicks as n,
  onStatus as o,
  fetchCandles as p,
  Route$4 as q,
